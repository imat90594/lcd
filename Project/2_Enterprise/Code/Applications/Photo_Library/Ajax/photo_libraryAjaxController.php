...
class photo_libraryAjaxController extends applicationsSuperController
{
	...
	public function deleteImageAction()
	{
		if(isset($_POST["image_id"]))
		{
			...
			if(is_readable(STAR_SITE_ROOT."/Data/Images/{$image_details['album_folder']}/original/{$image_details["path"]}"))
			unlink(STAR_SITE_ROOT."/Data/Images/{$image_details['album_folder']}/original/{$image_details["path"]}");
			if(is_readable(STAR_SITE_ROOT."/Data/Images/{$image_details['album_folder']}/{$image_details["dimensions"]}/{$image_details["path"]}"))
			unlink(STAR_SITE_ROOT."/Data/Images/{$image_details['album_folder']}/{$image_details["dimensions"]}/{$image_details["path"]}");
			if(is_readable(STAR_SITE_ROOT."/Data/Images/{$image_details['album_folder']}/{$image_details["dimensions"]}_thumb/{$image_details["path"]}"))
	...
	public function sortImagesAction()
	{
		...
		if($items)
		{
			...
			$imagesModel->updateImageSortingNumber($items);
		}
	...
	//-------------------------------------------------------------------------------------------------------------------------
	//sort the albums
	public function sortAlbumsAction()
	{
		$items = $_POST["items"];
		...
		if($items)
		{
			...
			$albumsModel->updateAlbumSortingNumber($items);
		}
	...
	{
		$album = new album();
		$album->setAlbumId($_POST["album_id"]);
		$album->updateOneColumn("is_used", $_POST["val"]);
