...
//-------------------------------------------------------------------------------------------------	
	...
	public function displayJobsNavigation()
	{	
		$content = $this->renderTemplate('Project/'.DOMAIN.'/Design/Applications/Job_Manager/Main_App_Layout/templates/side_navigation.phtml');
		response::getInstance()->addContentToTree(array('APPLICATION_LEFT_COLUMN'=>$content));
	}
...
//-------------------------------------------------------------------------------------------------	
	...
	{
		$content = $this->renderTemplate('Project/'.DOMAIN.'/Design/Applications/Job_Manager/Controllers/templates/jobs/popup_dialogs.phtml'); 
		response::getInstance()->addContentToTree(array('POPUP_DIALOG'=>$content));
	}
