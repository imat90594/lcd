...
class dropdown_renderer
{
	...
	private static $data_path   = "Project/1_Website/Code/Applications/Careers/Modules/pickers/"; //path of the dependencies file
	public static $year_start  = 1970; //for date picker
	public static $year_end    = 2030; //for date picker
	...
	*/
	...
	public static function makeCustomDatePicker($name, $class = NULL, $first_value = array("months" => "MMM", "days" => "DD", "years" => "YYY"), $selected_values = NULL)
	{
		//first value
		$first_dd = (isset($first_value["days"])) ? $first_value["days"] : "";
		$first_mm = (isset($first_value["months"])) ? $first_value["months"] : "";
