 ...
 * @date 10/3/2013
 * @required settings.php, PHPMailerAutoload.php;
 * 
 */

require_once 'Project/Model/Settings/settings.php';
require_once 'Project/1_Website/Code/Applications/Careers/Modules/phpmailer/PHPMailerAutoload.php';
...
class mailer
{
 	 ...
 	 * @params string $email_message - email message message of the email
 	 * @params string $to - this will be the receiver of an email
	 * @params string $cc - this will be the carbon copy of the email 
	 * @return boolean - return true/false
 	 */
 	
	public static function mail_with_attachment($from, $subject, $attachments, $email_message, $to = NULL, $cc = NULL)
	{
		...
		foreach($attachments as $attachment)
		{
			...
			//make sure to put \r\n to make the second attachment working
	...
	public static function send_with_phpmailer($from, $subject, $body, $to = NULL, $attachments = NULL, $cc = NULL, $bcc = NULL, $alt_body = NULL)
	{
		...
		//if receiver is not specified get it to the database
		if($to == NULL)
			$to[] = array("email" => $settings->getToEmail());
